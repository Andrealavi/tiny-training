...
def build_dataset():
    if configs.data_provider.dataset == 'image_folder':
        dataset = ImageFolder(
            root="/home/andrealavi/dataset/flowers102", # TODO
            transforms=ImageTransform(),
        )
    elif configs.data_provider.dataset == 'gestures':
        dataset = ImageFolder(
            root="/home/andrealavi/dataset/gestures",
            transforms=ImageTransform(),
        )
    elif configs.data_provider.dataset == 'new_gestures':
        dataset = ImageFolder(
            root="/home/andrealavi/dataset/new_gestures",
            transforms=ImageTransform(),
        )
    elif configs.data_provider.dataset == 'pets':
        dataset = ImageFolder(
            root="/home/andrealavi/dataset/pets",
            transforms=ImageTransform(),
        )
